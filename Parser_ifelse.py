        ...
        if self.cur_char == "a":
          ...
          if self.cur_char == "y":
            ...
            if self.cur_char == "(":
              ...
              while self.cur_char is not None and self.cur_char in "ABCDEFG ": # then there are notes
                if self.cur_char.isspace():
                  self.advance()
                  continue
...
lexer_Dfa1 = LexerDfa("""Variable= A4w B3h C4w
...
lexer_DFA3 = LexerDfa("Birthday= A4w A4h B4w A4w D4h C4w")
lexer_DFA3.run()
